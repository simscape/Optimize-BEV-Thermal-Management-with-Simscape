function setCondenserLengthSDO(condenser_L)
%% Description:
...
sdo.setValueInModel(mdlName,'condenser_air_area_flow',round(condenser_air_area_flow,4));
sdo.setValueInModel(mdlName,'condenser_air_area_primary', round(condenser_air_area_primary,4));
sdo.setValueInModel(mdlName,'condenser_air_area_fins', round(condenser_air_area_fins,4));
sdo.setValueInModel(mdlName,'condenser_tube_area_webs', round(condenser_tube_area_webs,4));
sdo.setValueInModel(mdlName,'condenser_tube_Leq', round(condenser_tube_Leq,4));
sdo.setValueInModel(mdlName,'condenser_L', condenser_L);
end