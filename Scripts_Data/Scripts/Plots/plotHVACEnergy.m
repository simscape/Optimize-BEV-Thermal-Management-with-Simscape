...
set(gca, 'XTick',1:numel(hvacEnRed),'XTickLabel', labelsSrtd,'FontSize',11);
title(['Total HVAC energy: ',num2str(sum(hvacEnRed)),' kWh']);
ylabel('HVAC Losses in kWh');

% Set color and dimensions of the bar plot
set(h1,'CData',Colors(1:numel(hvacEnRed),:),'BarWidth',1);
