...
% Get Simulation time 
simTime = slog.Compressor.Power_sensor.P.series.time;

%% Compressor
cmprsPwr = slog.Compressor.Power_sensor.P.series.values('W');
...
out.energyPTC     = PTCEn;
out.energyHVACtot = cmprsEn+ PumpsEn + blowEn + fanEn + DCDCEnLoss + PTCEn + heaterEn;
